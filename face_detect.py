...
The parameter < face_detectin_root > is the root directory of the project where is face_detect.py. And < image_name > is the name of any image that you want detect faces in the root directory.
